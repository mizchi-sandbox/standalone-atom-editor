...
{Point, Range} = require '../lib/text-buffer'
...
class TokenizedBuffer extends Model
  ...
  constructor: ({@buffer, @tabLength, @invisibles}) ->
    ...
    # @subscribe atom.grammars.onDidAddGrammar(@grammarAddedOrUpdated) # wip
    # @subscribe atom.grammars.onDidUpdateGrammar(@grammarAddedOrUpdated) # wip
  ...
  deserializeParams: (params) ->
    # params.buffer = atom.project.bufferForPathSync(params.bufferPath) # wip
    params
  ...
  setGrammar: (grammar, score) ->
    ...
    # @configSettings = tabLength: atom.config.get('editor.tabLength', scope: @rootScopeDescriptor) # wip
    @configSettings = tabLength: 2
