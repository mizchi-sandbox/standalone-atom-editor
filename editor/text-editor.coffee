...
{Point, Range} = TextBuffer = require '../lib/text-buffer'

LanguageMode = require './language-mode'
DisplayBuffer = require './display-buffer'
Cursor = require './cursor'
Selection = require './selection'
# TextMateScopeSelector = require('first-mate').ScopeSelector # wip
...
class TextEditor extends Model
  ...
  isBufferRowCommented: (bufferRow) ->
    if match = @lineTextForBufferRow(bufferRow).match(/\S/)
      ...
      # @commentScopeSelector ?= new TextMateScopeSelector('comment.*') # wip
      # @commentScopeSelector.matches(scopeDescriptor) # wip
      false
